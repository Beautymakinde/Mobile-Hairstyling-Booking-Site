        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="card p-8 text-center">
            ...
            {zelleInfo && (zelleInfo.email || zelleInfo.phone) && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left">
                ...
                <p className="text-xs text-blue-800 mt-2 font-medium">
                  After sending your deposit, please text or email a screenshot of the payment confirmation to verify your booking.
                </p>
              </div>
            )}
            ...
            <div className="bg-background p-6 rounded-lg mb-6">
              <h3 className="font-semibold text-lg mb-4">Questions or Issues?</h3>
              <div className="space-y-2 text-sm">
                <p className="text-muted">Contact us if you have any questions about your booking:</p>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:Layzcentral@gmail.com" className="text-primary hover:underline">Layzcentral@gmail.com</a>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <a href="tel:8723604239" className="text-primary hover:underline">(872) 360-4239</a>
                </div>
              </div>
            </div>
