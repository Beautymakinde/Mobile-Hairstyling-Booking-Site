            ...
            <div>
              ...
              <ul className="space-y-3 text-white/80 font-raleway">
                <li className="flex items-start gap-3">
                  ...
                  <a href="tel:8723604239" className="hover:text-white transition-colors">
                    (872) 360-4239
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <a href="mailto:Layzcentral@gmail.com" className="hover:text-white transition-colors">
                    Layzcentral@gmail.com
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 mt-1 flex-shrink-0 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
