  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <Link href="/admin/dashboard" className="text-xl font-heading font-bold text-primary">
          Admin
        </Link>
        <button
      ...
      <div className="flex">
        ...
        `}>
          <div className="h-full flex flex-col">
            ...
            <div className="h-16 flex items-center px-6 border-b border-gray-200">
              <Link href="/admin/dashboard" className="text-2xl font-heading font-bold text-primary">
                Admin
              </Link>
            </div>
            ...
            <div className="p-4 border-t border-gray-200 space-y-2">
              ...
              <Link
                href="/admin/login"
                className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 min-h-screen">
          {/* Top bar */}
          <div className="bg-white border-b border-gray-200 px-4 lg:px-8 py-4 hidden lg:block">
